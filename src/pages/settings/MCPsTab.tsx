                                                ...
                                                {server.tools!.map((tool, i) => {
                                                    ...
                                                    return (
                                                        <span key={i}
                                                            ...
                                                            {tool.name}
                                                            <ToolTip id={`tool-${server.name}-${tool.name}`} clickable className="mcp-detail">
                                            ...
                                            <div className="chip-list">
                                                {prompts!.map((prompt, i) => (
                                                    <span key={i}
                                                        ...
                                                        {prompt.name}
                                                        <ToolTip id={`prompt-${server.name}-${prompt.name}`} clickable className="mcp-detail">
                                            ...
                                            <div className="chip-list">
                                                {resources!.map((resource, i) => (
                                                    <span key={i}
                                                        ...
                                                        {resource.name}
                                                        <ToolTip id={`resource-${server.name}-${resource.uri}`} clickable className="mcp-detail">
